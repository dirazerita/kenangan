...
object Strings {
    ...
    const val SB_SHEET_ONLY = "Gambar saja (gratis)"
    const val SB_SHEET_WITH_MOTION = "Gambar + video contoh"
    const val SB_SHEET_MOTION_FREE = " — gratis, klip sudah ada"
    const val SB_SHEET_MAKING_CLIP = "Membuat klip adegan %1/%2… (±1–3 menit per klip)"
    const val SB_SHEET_ASSEMBLING = "Merakit video contoh…"
    const val SB_SHEET_MOTION_NO_SCENES = "Belum ada adegan dengan gambar siap — video contoh dilewati."
    ...
    const val SETTINGS_DATA_SIZE = "Ukuran data"
    const val SETTINGS_DATA_MEASURING = "menghitung…"
    const val SETTINGS_DATA_FREE = "sisa ruang"
    const val SETTINGS_DATA_MOVE = "Pindahkan ke drive lain…"
    const val SETTINGS_DATA_MOVE_TITLE = "Pindahkan folder data"
    const val SETTINGS_DATA_MOVE_CONFIRM = "Pindahkan sekarang"
    const val SETTINGS_DATA_MOVING = "Memindahkan data — jangan tutup aplikasi"
    const val SETTINGS_DATA_MOVED = "Selesai. Data sekarang tersimpan di: "
    const val SETTINGS_DATA_BUSY = "Tidak bisa dipindahkan saat ada pembuatan video yang sedang berjalan."
    const val SETTINGS_DATA_NO_SPACE = "Ruang di drive tujuan tidak cukup untuk data sebesar ini."
    const val SETTINGS_DATA_SAFE_NOTE = "Data disalin dulu sampai lengkap, baru yang lama dihapus. Jika ada gangguan di tengah jalan, data lama Anda tetap utuh."
    ...
    const val SB_ADD_AIREF_DESC_HINT = "Kosongkan untuk memakai usulan di atas — atau tulis adeganmu sendiri…"
    ...
    const val SB_SHEET_BUTTON = "Pratinjau Storyboard"
    const val SB_SHEET_RENDERING = "Membuat pratinjau…"
    const val SB_SHEET_SAVED = "Pratinjau storyboard (gambar + video) tersimpan di: %1"
    const val SB_SHEET_SAVED_NO_VIDEO = "Lembar storyboard tersimpan (video dilewati — belum ada gambar adegan): %1"
    const val SB_SHEET_FAILED = "Gagal membuat pratinjau storyboard: %1"
