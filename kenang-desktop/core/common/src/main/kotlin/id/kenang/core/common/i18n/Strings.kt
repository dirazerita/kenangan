...
object Strings {
    ...
    const val SB_CLIP_READY = "🎞 klip siap"
    ...
    const val SB_ADD_AIREF_SUGGEST_NOTE = "Usulan dipilih agar menyambung cerita — tidak mengulang adegan yang sudah ada di storyboard."
