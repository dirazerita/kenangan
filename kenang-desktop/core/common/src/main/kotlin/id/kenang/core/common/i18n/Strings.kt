...
object Strings {
    ...
    const val TALK_SUBTITLE = "Foto berbicara sesuai naskah Anda — suaranya dikloning dari file rekaman, pilih suara yang tersedia, atau pakai file MP3 Anda langsung. Memakai OmniHuman 1.5 (ByteDance), model foto-berbicara terbaik di fal.ai."
    ...
    const val TALK_VOICE_MP3 = "Dari file MP3 (langsung)"
    const val TALK_MP3_PICK = "Pilih file suara (MP3/WAV/M4A, maksimal 60 detik)"
    const val TALK_MP3_NOTE = "Foto akan berbicara persis mengikuti suara di file ini — tanpa naskah, tanpa biaya suara. Rekaman lebih dari 60 detik dipotong ke 60 detik."
    const val TALK_MP3_SECONDS = "±%1 dtk"
    const val TALK_MP3_ESTIMATE = "±%1 dtk suara dari file · video $%2 · suara $0.00"
    const val TALK_NEED_MP3 = "Pilih file MP3-nya dulu."
    const val TALK_PHASE_PREPARING = "Menyiapkan file suara…"
