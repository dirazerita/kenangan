...
object Strings {
    ...
    const val SB_SHEET_BUTTON = "Buat Gambar Storyboard"
    const val SB_SHEET_RENDERING = "Menyusun gambar storyboard…"
    const val SB_SHEET_SAVED = "Gambar storyboard tersimpan: %1"
    const val SB_SHEET_FAILED = "Gagal membuat gambar storyboard: %1"
