...
fun StoryboardScreen(
    ...
    if (showAddRefScene) {
        AddRefSceneDialog(
            ...
            onDismiss = { refSceneFile = null; showAddRefScene = false },
        )
    }
            ...
            Column(Modifier.padding(12.dp)) {
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    if (videoBusy) {
                        ...
                        // app-internal until the final video — click plays it.
                        Box(
                            Modifier.clickable {
                                scene.local_clip_path?.let { p ->
                                    runCatching { java.awt.Desktop.getDesktop().open(java.io.File(p)) }
                                }
                            },
 ...
 * SOURCE of an AI-generated keyframe. Key promise surfaced in the dialog:
 * people with cut-off/unclear faces in the reference are omitted, never given
 * an invented face.
 */
@Composable
